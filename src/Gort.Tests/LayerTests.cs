...
public class LayerTests
{
    ...
    {
        var (w, h, pt) = LayerWindow.ComputeFit(null, "Oi", 15, 1.0, 800, 600, 8);
    ...
    public void AutoFit_TallText_ShrinksFontToMaxH()
    {
        ...
        var (w, h, pt) = LayerWindow.ComputeFit(null, text, 15, 1.0, 800, 120, 8);
        ...
        var (_, _, pt12) = LayerWindow.ComputeFit(null, text, 15, 1.0, 800, 120, 12);
        Assert.True(pt12 >= 12);
    }
    ...
    {
        var (w, h, pt) = LayerWindow.ComputeFit(null, "Hello world", 15, 1.0, 0, 600, 8);
    ...
    {
        var (w, h, pt) = LayerWindow.ComputeFit(null, "  ", 15, 1.0, 800, 600, 8);
        Assert.Equal(15, pt);
